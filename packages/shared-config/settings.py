...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = Field(
        default="postgresql+asyncpg://hawa_user:hawa_password@localhost:5432/hawa_sorani_voice",
        description="PostgreSQL async connection string"
    )
    DATABASE_SYNC_URL: str = Field(
        default="postgresql://hawa_user:hawa_password@localhost:5432/hawa_sorani_voice",
